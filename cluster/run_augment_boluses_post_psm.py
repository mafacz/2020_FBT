...
for batch_idx in range(0,100, step_size + 1):
    ...
    job_name="augment_boluses_ppsm_{}".format(batch_idx)
    mem_in_mbytes = 6000
    n_cpu_cores = 8
    n_compute_hours = 12

    compute_script_path="/cluster/home/faltysm/source/2020_VolumeChallenge/scripts/augment_boluses_post_psm.py"
